...
void main() async{
  ...
  runApp(
    MultiProvider(
        providers: [
          ChangeNotifierProvider(create: (_) => SignUpUserInfoProvider()),
          ChangeNotifierProvider(create: (_) => ImageFromGallery()),
          ChangeNotifierProvider(create: (_) => ImageFromGalleryProvider())
    ],
      child:const MyApp()),
    );
}
